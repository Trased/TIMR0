...
set_property PACKAGE_PIN U17 [get_ports CLK_EX]						
	set_property IOSTANDARD LVCMOS33 [get_ports CLK_EX]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets CLK_EX_IBUF]
